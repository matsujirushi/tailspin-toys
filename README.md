...
On the home page, users can browse the game catalog in pages of nine games, filter the current page by selecting one or more categories and a single publisher, and combine those filters to narrow results.
